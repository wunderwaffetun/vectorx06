<?php get_header(); ?>
    <div class="index-about-block flex">
        ...
        <div class="right-side">
            <a  class="tag" class = "button-popup" onclick="startPopupAnimation()"">Pre-IPO*</a>
            <a  class="name" class = "button-popup" onclick="startPopupAnimation()"">Инвестируйте раньше остальных игроков</a>
            <a  class="link" class = "button-popup" onclick="startPopupAnimation()"">Подробнее <span></span></a>
