<?php get_header(); ?>
    ...
    <div class="faq-block">
        ...
        <div class="list">
            ...
            <div class="item">
                <div class="name">
                    Какие финансовые инструменты и площадки мне доступны?
                </div>
                <div class="text">
                    <p>ООО «Вектор Икс» открывает Вам доступ ко всем инструментам и секциям Московской и Санкт-Петербургской бирж.</p>
                    <br/><p>Например:</p>
                    <br/><p>- акции</p>
                    <br/><p>- облигации</p>
                    <br/><p>- валютный рынок</p>
                </div>
            </div>
            <div class="item">
                <div class="name">
                ...
                <div class="text">
                    <p>В рамках доверительного управления комиссионное вознаграждение определяется стратегией, которую Вы выбрали, в паспорте которой будет прописан тариф. В индивидуальной - Вы определяете вознаграждение совместно с доверительным управляющим.</p>
                    <br/><p>А по брокерскому обслуживанию комиссия определяется характером активов, местом размещения и объемом совершенных операций.</p>
                </div>
            </div>
            <div class="item">
                <div class="name">
                    Могу ли я получить инвестиционное консультирование, управляя самостоятельно?
                </div>
                <div class="text">
                    Конечно, являясь клиентом ООО «Вектор Икс», Вы можете обратиться к инвестиционному советнику по любому консультационному вопросу.
                </div>
            </div>
            <div class="item">
                <div class="name">
